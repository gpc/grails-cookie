...
class CookieIntegrationSpec extends Specification {
    ...
    void "deleteCookie issues a Set-Cookie that expires the cookie immediately"() {
        when:
        ...
        and: 'a zero Max-Age is serialised as an epoch Expires by Tomcat 11 (Servlet 6.1)'
        setCookieHeader.contains('Max-Age=0') || setCookieHeader.contains('Expires=Thu, 01 Jan 1970')
    }
